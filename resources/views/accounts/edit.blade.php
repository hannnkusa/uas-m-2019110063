        ...
        <div class="col-auto my-auto">
          <div class="h-100">
            ...
            <p class="mb-0 font-weight-bold text-sm">
              {{ __('this form used to be create new account') }}
            </p>
          </div>
        </div>
  ...
  <div class="container-fluid py-4">
    <div class="card">
      ...
      <div class="card-body pt-4 p-3">
        <form action="{{ route('accounts.update', ['account' => $account->id]) }}" method="POST" role="form text-left">
          @method('PATCH')
          @csrf
          @if($errors->any())
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="@error('nama')border border-danger rounded-3 @enderror">
                  <input class="form-control" value="{{ old('nama') ?? $account->nama }}" type="text" placeholder="Nama" id="nama" name="nama">
                  @error('nama')
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="@error('jenis')border border-danger rounded-3 @enderror">
                  <select class="form-select" value="{{ old('jenis') ?? $account->jenis }}" placeholder="Pilih Jenis" id="jenis" name="jenis">
